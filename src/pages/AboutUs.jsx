  ...
  return (
    <>
      ...
      <div className='pt-24 flex flex-col gap-32'>
        ...
        <section>
          <div className='bg-base-300 py-12 flex flex-col gap-32 text-center'>
            <div className='flex flex-col gap-8 max-w-6xl mx-auto'>
              <h2 className='font-bold text-3xl italic'>
                WHAT MAKES US <span className='text-secondary'>TICK</span>
              </h2>
              <div className='p-8 bg-base-100 rounded-lg flex flex-col gap-8 text-xl font-medium h-60 justify-center'>
                <span>
          ...
          <div className='bg-primary text-base-100 py-12 flex flex-col text-center'>
            <div className='max-w-6xl mx-auto flex flex-col items-center gap-6 text-xl'>
              ...
              <div className='flex items-end gap-4 ml-24'>
